...
public class ItemTwoAdapter extends RecyclerView.Adapter<ItemTwoAdapter.ViewHolder> {
    ...
    public ItemTwoAdapter(ArrayList<FoodItemList> foodItemLists, Context context) {
    ...
    @Override
    public ItemTwoAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_items, parent, false);
        ItemTwoAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ItemTwoAdapter.ViewHolder holder, final int position) {
